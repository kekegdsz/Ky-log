 ...
 */
public class KyFilePrinter implements KyLogPrinter {
    private static final ExecutorService EXECUTOR = Executors.newSingleThreadExecutor();
    private final String logPath;
    private final long retentionTime;
    private LogWriter writer;
    private volatile PrintWorker worker;
    private static KyFilePrinter instance;
     ...
     */
    public static synchronized KyFilePrinter getInstance(String logPath, long retentionTime) {
        if (instance == null) {
            instance = new KyFilePrinter(logPath, retentionTime);
        }
        return instance;
    }


    private KyFilePrinter(String logPath, long retentionTime) {
    ...
    public void print(@NonNull KyLogConfig config, int level, String tag, @NonNull String printString) {
        ...
        worker.put(new KyLogMo(timeMillis, level, tag, printString));
    }

    private void doPrint(KyLogMo logMo) {
    ...
    private class PrintWorker implements Runnable {
        ...
        private BlockingQueue<KyLogMo> logs = new LinkedBlockingQueue<>();
