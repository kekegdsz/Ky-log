...
import com.ky.android.library.utils.KyDisplayUtil;

public class KyViewPrinterProvider {
    ...
    public KyViewPrinterProvider(FrameLayout rootView, RecyclerView recyclerView) {
    ...
    public void showFloatingView() {
        ...
        params.bottomMargin = KyDisplayUtil.dp2px(100, rootView.getResources());
    ...
    public void showLogView() {
        ...
        FrameLayout.LayoutParams params =
            new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, KyDisplayUtil.dp2px(160, rootView.getResources()));
